...
public class FSMPopulator {
   ...
   */
  private static void addOnePath (final FSM<Set<Pair<Word, Word>>, String> fsm,
  ...
  public static void addPath (final FSM<Set<Pair<Word, Word>>, String> wfs, final Word w1,
          final String difference1to2, final Word w2, final String difference2to1) {
  ...
  public static String[] findNearestPair (final FSM<Set<Pair<Word, Word>>, String> wfs,
    ...
    final Map<String, Set<Pair<Word, Word>>> map = FSMPopulator
  ...
  private static Map<String, Set<Pair<Word, Word>>> findNearestPathsData (
    ...
    if ((fsm.getData () != null)
      ...
      FSMPopulator.removePairsWithWordToAvoid (wordToAvoid,
    ...
    if (fsm.getTransitions () != null) {
      for (final String s : fsm.getTransitions ().keySet ()) {
        ...
        if (s.startsWith ("+") && (positive.indexOf (s.charAt (1)) != -1)) {
          ...
          result.putAll (FSMPopulator.findNearestPathsData (fsm.getTransitions ()
  ...
  private static Map<String, Set<Pair<Word, Word>>> searchPairsByPath (
    ...
    return FSMPopulator.findNearestPathsData (fsm, wordToAvoid, negative,
