...
/**
 * This is the legacy GUI class made in swing / SWT. It builds an awful frame with
 * two buttons, a text field, a label grid, and a tab with some settings.
 * 
 * @author LiBe
 * 
 */
public class OldUserInterface {
  ...
  private static class SubmitSentenceAction extends AbstractAction {
    ...
    public void actionPerformed (final ActionEvent e) {
      ...
      final String[] wordsS = BuildEquationFromSentence
      ...
      for (int i = 0 ; i < jlabelsResult.length ; i++) {
        ...
        new Thread () {
          ...
          public void run () {
            ...
            final String equation = BuildEquationFromSentence.getEquation (
                data, word);
            // The cost
            SubmitSentenceAction.this.cost += BuildEquationFromSentence
                .getCost (equation);
            // We write it
      ...
      public void actionPerformed (final ActionEvent e) {
        ...
        // Here we launch the threads
          ...
          new Thread () {
            ...
            public void run () {
              // Getting the result here
              final List<Word> words = BuildRebusFromSentence.getRebusFromSentence (
